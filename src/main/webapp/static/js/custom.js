    ...
    if ($('#world-map-gdp').length) {
        ...
        $('#world-map-gdp').vectorMap({
            ...
            onRegionClick: function (element, code, region) {
                var parsedTrips = JSON.parse(tripsAmount);
                var amount = parsedTrips[region];
                if (amount != undefined) {
                    infoNotify("Kraj " + region + " został odwiedzony przez klientów " + amount + " razy.");
                } else {
                    infoNotify("Kraj " + region + " nie został jeszcze odwiedzony przez żadnego z klientów.");
                }
            }
        });
