            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Miejsca
                            <small>Lista wszystkich miejsc</small>
                        </h3>
                    </div>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <p class="text-muted font-13 m-b-30">
                                    Lista wszystkich dodanych miejsc.
                                </p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary"
                                                        onclick="location.href='/place/info/${place.id}'">Szczegóły
                                                </button>
                                                <button class="btn btn-primary"
                                                        onclick="location.href='/place/edit/${place.id}'">Edytuj
                                                </button>
                                            </td>
                                            <td>
                                                <form:form action="/place/delete/${place.id}" method="post">
