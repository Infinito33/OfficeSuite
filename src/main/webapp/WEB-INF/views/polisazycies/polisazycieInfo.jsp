        ...
        <div class="right_col" role="main">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Szczegółowe informacje o polisie</h2>
                        ...
                        <div class="x_content">
                            <br/>
                            <form:form modelAttribute="polisazycie"
                                       class="form-horizontal form-label-left">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Numer</label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">${polisazycie.policyNumber}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">${polisazycie.client.name}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">${polisazycie.client.lastname}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">${polisazycie.information}</label>
                                    </div>
                                </div>

                                <c:set value="/polisazycie/" var="returnP"/>
