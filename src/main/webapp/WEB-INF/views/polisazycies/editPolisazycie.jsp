            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br/>
                            <form:form action="/polisazycie/edit/${polisazycie.id}" method="post" modelAttribute="polisazycie"
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <form:input path="policyNumber" type="text" class="form-control has-feedback-left"
