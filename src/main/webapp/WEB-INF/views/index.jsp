        ...
        <div class="right_col" role="main">
            ...
            <div class="row tile_count">
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-user"></i> Liczba klientów</span>
                    <div class="count">${clientsAmount}</div>
                    <%--<span class="count_bottom"><i class="green">4% </i> From last Week</span>--%>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-clock-o"></i> Liczba wycieczek</span>
                    <div class="count">${tripsAmount}</div>
                    <%--<span class="count_bottom"><i class="green"><i--%>
                    <%--class="fa fa-sort-asc"></i>3% </i> From last Week</span>--%>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-user"></i> Ilość  hoteli</span>
                    <div class="count green">${hotelsAmount}</div>
                    <%--<span class="count_bottom"><i class="green"><i--%>
                    <%--class="fa fa-sort-asc"></i>34% </i> From last Week</span>--%>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-user"></i> Ilość miejsc</span>
                    <div class="count">${placesAmount}</div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Sprzedane wycieczki
                                <small>Geo prezentacja</small>
                            </h2>
                        ...
                        <div class="x_content">
                            <div class="dashboard-widget-content">
                                <div class="col-md-2 hidden-small">
                                    <h2 class="line_30">Procentowy udział krajów</h2>

                                    <table class="countries_list">
                                        <tbody>
                                        <script>var tripsAmount = '${tripsWithAmount}';
                                        console.log(tripsAmount);
                                        debugger;</script>
                                        <c:forEach items="${tripsWithPercentage}" var="entry">
                                            <tr>
                                                <td>${entry.key}</td>
                                                <td class="fs15 fw700 text-right">${entry.value}%</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
