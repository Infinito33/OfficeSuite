...
@ComponentScans(value = {@ComponentScan("th.database.dao"),
        @ComponentScan("th.database.service"), @ComponentScan("th.converter"), @ComponentScan("th.database.service.impl")})
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setPackagesToScan("th.model.entities");
        return factoryBean;
    }
