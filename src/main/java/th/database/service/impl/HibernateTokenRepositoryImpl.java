...
import th.database.dao.impl.AbstractDao;
import th.model.entities.PersistentLogin;
...
public class HibernateTokenRepositoryImpl extends AbstractDao<String, PersistentLogin> implements PersistentTokenRepository {
    ...
    public PersistentLogin getById(Integer id) {
        return null;
    }

    public void initEntityRelations(PersistentLogin entity) {
